...
namespace MovieRentals
{
    public partial class Form1 : Form
    {
        ...
        // Change these configurations according to your host and database details
        // NOTE: This program is used with PhpMyAdmin Xampp, Wamp, Mamp, or any other alternative program
        ...
        private void ShutDown_Application_Click(object sender, EventArgs e)
        {
            Environment.Exit(0);
        }
        ...
        // This coding for time period button
        ...
        private void RentingMovie_SelectedIndexChanged(object sender, EventArgs e)
        {
            // This automatically closes the connection when needed
        ...
        {
            // Only executes if a customer is selected 
        ...
        private void Minimize_Application_Click(object sender, EventArgs e)
        {
